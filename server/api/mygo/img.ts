...
export default defineEventHandler(async (event) => {
  ...
  const scoredResults: Array<{ url: string, alt: string, score: number }> = []
  const fullMatchResults: Array<{ url: string, alt: string, score: number }> = []
  ...
  if (Object.prototype.hasOwnProperty.call(custom_keymap, keyword)) {
